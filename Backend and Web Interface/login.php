...
<head>
	...
	<link rel="shortcut icon" href="file://C:/Users/Ani/Documents/GitHub/Scanfer/app/src/main/res/drawable/ic_launcher.png" >
	<link rel="icon" type="image/png" href="C:/Users/Ani/Documents/GitHub/Scanfer/app/src/main/res/drawable/ic_launcher.png" sizes="192x192">
...
<body style="background-image:url('./image.png');background-repeat: no-repeat;background-size: cover;">
	<div class="container login">
		<form class="login-form form-horizontal" method="post" style="background: rgb(25, 25, 54);background: rgba(25, 25, 54, .3);color:#663300;">
			...
			?>
			<fieldset>
				<legend style="font-weight:bold;color:BD0FC5;">Dashboard</legend>
