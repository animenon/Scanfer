...
public class MainActivity extends AppCompatActivity implements QRCodeReaderView.OnQRCodeReadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferences = getSharedPreferences("Scanfer", Context.MODE_PRIVATE);
  ...
  @Override
    ...
    public void payMoney(String amount, String type, final String tollID){
        ...
        Paper.book().write("balance", "0");
        Toast.makeText(context, "Payment Successful", Toast.LENGTH_SHORT).show();

        /*
        String url = "http://192.168.2.5/pay_money.php?amount="+amount+"&user_id="+userID+"&ride_type="+type+"&toll_id="+tollID;
